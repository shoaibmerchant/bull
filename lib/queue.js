...
/* Added reference to API module */ /* Added by Shoaib */
var QueueApi = require('./api');
...
/* Listen function which calls the Queue Api function and starts listening on the ports */
Queue.prototype.listen = function(port, debug){
  var self = this;

  //Set the port as member variable in Queue
  self.port = port;

  //Create instance of the queueAPI object to initialize the server
  var httpAPI = QueueApi(self, port, debug);

  //Set Api activated flag true
  self.apiActivated = true;
}
